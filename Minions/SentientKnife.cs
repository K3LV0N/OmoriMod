...
namespace OmoriMod.Minions
{
    ...
    public class SentientKnifeItem : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<SentientKnifeProj>(); // This item creates the minion projectile
        }
    ...
    public class SentientKnifeProj : SadProj
    {
        public override void SetStaticDefaults()
        {
