...
namespace OmoriMod.Content.NPCs.State_Management
{
    ...
    /// </para>
    /// </summary>
    public class BehaviourManager(OmoriBehaviourNPC npc, int totalFrames)
    {
        /// <summary>
        ...
        /// <summary>
        /// Adds a new animation to <see cref="behaviourInfo"/> using a <see cref="NPCAnimation"/>.
        /// <para>
        ...
        /// <param name="animation">The <see cref="NPCAnimation"/> object containing the frame indices.</param>
        ...
        public bool AddAnimation(string animationName, NPCAnimation animation)
        {
        ...
        {
            return AddAnimation(animationName, new NPCAnimation(beginIndex, endIndex));
        }
