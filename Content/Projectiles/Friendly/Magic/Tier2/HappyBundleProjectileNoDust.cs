...
{
    public class HappyBundleProjectileNoDust : HappyProjectile
    {
        ...
        {
            AI_TravelingBundleProjectile<HappyBoltProjectileNoDust>(damagePerProjectile: 18, ProjectileSpeedOnSpawn: 6, volleys: 4, interval: 60);
        }
    }
}
