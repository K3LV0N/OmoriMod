...
{
    public class GShrooberProjectile : ModSummonProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<GShrooberBuff>());
                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<GShrooberBuff>()))
            {
        ...
        public override void AI()
        {
            ...
            // This minion never deals contact damage or flies at enemies, only shoots from range
            ...
            if (foundTarget && distanceFromTarget <= ShootRange && ShootTimer <= 0)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(
                        ...
                        Projectile.Center,
                        shootVelocity,
                        ModContent.ProjectileType<GShrooberPoisonProjectile>(),
        ...
        /// <summary>
        /// Keeps the minion floating near the player at all times. It never flies out to chase
        /// enemies - attacking is handled entirely by firing <see cref="GShrooberPoisonProjectile"/>
        /// from range while idling.
        /// </summary>
